...
export const getMyPost = () => async(dispatch) => {
    try {
        ...
        let response = await axios.get(`https://tasty-fez-goat.cyclic.app/post/myAllPost`, config);
...
export const uploadPost = (caption, image) => async (dispatch) => {
    try {
        ...
        const response = await axios.post('https://tasty-fez-goat.cyclic.app/post/upload', data, config);
...
export const deleteMyPost = (id) => async(dispatch) => {
    try {
        ...
        let response = await axios.delete(`https://tasty-fez-goat.cyclic.app/post/delete/${id}`, config);
        console.log(response.data)
        deletePostSuccess();
    } catch (error) {
        console.log(error)
...
export const deleteMyAccount = () => async(dispatch) => {
    try {
        ...
        let response = await axios.delete(`https://tasty-fez-goat.cyclic.app/user/deleteAccount`, config);
        console.log(response.data)
    } catch (error) {
        console.log(error);
    }
...
export const forgetPassword = (email) => async(dispatch) => {
    try {
        ...
        let response = await axios.post(`https://tasty-fez-goat.cyclic.app/user/forgotPassword`, data);
        console.log(response.data)
...
export const resetPassword = (token, password) => async(dispatch) => {
    try {
        ...
        let response = await axios.post(`https://tasty-fez-goat.cyclic.app/user/resetPassword/${token}`, data);

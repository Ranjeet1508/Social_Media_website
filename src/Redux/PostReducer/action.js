...
export const getAllPost = () => async (dispatch) => {
    try {
        ...
        const response = await axios.get('https://tasty-fez-goat.cyclic.app/post/allPost', config);
...
export const likeUnlikePost = (id) => async (dispatch) => {
    try {
        ...
        const response = await axios.get(`https://tasty-fez-goat.cyclic.app/post/like_Unlike/${id}`, config);
...
export const getallComments = (postId) => async(dispatch) => {
    try {
        ...
        let response = await axios.get(`https://tasty-fez-goat.cyclic.app/comment/${postId}`, config);
...
export const addCommentsOnPost = (id, comment) => async(dispatch) => {
    try {
        ...
        let response = await axios.put(`https://tasty-fez-goat.cyclic.app/comment/add/${id}`, data, config);
        console.log(response.data)
    } catch (error) {
        console.log(error);
    }
...
export const deleteComment = (postId, commentId) => async(dispatch) => {
    try {
        ...
        let response = axios.delete(`https://tasty-fez-goat.cyclic.app/comment/delete/${postId}?commentId=${commentId}`, config);
        console.log(response.data);

...
export const getAllPost = () => async (dispatch) => {
    try {
        ...
        const response = await axios.get('https://social-media-backend-orpin-ten.vercel.app/post/allPost', config);
...
export const likeUnlikePost = (id) => async (dispatch) => {
    try {
        ...
        const response = await axios.get(`https://social-media-backend-orpin-ten.vercel.app/post/like_Unlike/${id}`, config);
...
export const getallComments = (postId) => async(dispatch) => {
    try {
        ...
        let response = await axios.get(`https://social-media-backend-orpin-ten.vercel.app/comment/${postId}`, config);
...
export const addCommentsOnPost = (id, comment) => async(dispatch) => {
    try {
        ...
        let response = await axios.put(`https://social-media-backend-orpin-ten.vercel.app/comment/add/${id}`, data, config);
        console.log(response.data)
    } catch (error) {
        console.log(error);
    }
...
export const deleteComment = (postId, commentId) => async(dispatch) => {
    try {
        ...
        let response = axios.delete(`https://social-media-backend-orpin-ten.vercel.app/comment/delete/${postId}?commentId=${commentId}`, config);
        console.log(response.data);
